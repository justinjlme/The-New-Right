...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000485ffe6900007faa50ea8994(
...
class phpbbtemplatetwiglexer_00000000485ffe6900007faa50ea8994 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder590b1ce126188440796529 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer590b1ce126197670877692 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties590b1ce126160311377174 = array(
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, 'set_environment', array('env' => $env), $this->initializer590b1ce126197670877692);

        return $this->valueHolder590b1ce126188440796529->set_environment($env);
    }
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer590b1ce126197670877692);

        return $this->valueHolder590b1ce126188440796529->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer590b1ce126197670877692);

        return $this->valueHolder590b1ce126188440796529->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer590b1ce126197670877692 = $initializer;
    }
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, '__get', array('name' => $name), $this->initializer590b1ce126197670877692);

        if (isset(self::$publicProperties590b1ce126160311377174[$name])) {
            return $this->valueHolder590b1ce126188440796529->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder590b1ce126188440796529;
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer590b1ce126197670877692);
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, '__isset', array('name' => $name), $this->initializer590b1ce126197670877692);
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, '__unset', array('name' => $name), $this->initializer590b1ce126197670877692);
    ...
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, '__clone', array(), $this->initializer590b1ce126197670877692);

        $this->valueHolder590b1ce126188440796529 = clone $this->valueHolder590b1ce126188440796529;
    }

    public function __sleep()
    {
        $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, '__sleep', array(), $this->initializer590b1ce126197670877692);

        return array('valueHolder590b1ce126188440796529');
    }
    ...
    {
        return $this->initializer590b1ce126197670877692;
    }
    ...
    {
        return $this->initializer590b1ce126197670877692 && $this->initializer590b1ce126197670877692->__invoke($this->valueHolder590b1ce126188440796529, $this, 'initializeProxy', array(), $this->initializer590b1ce126197670877692);
    }
    ...
    {
        return null !== $this->valueHolder590b1ce126188440796529;
    }
    ...
    {
        return $this->valueHolder590b1ce126188440796529;
    }
