                ...
                <tbody>
                  ...
                  <tr valign="top">
                     ...
                     <td>
                       ...
                       <select id="smpushPostAttriFunction" class="smpushPostFunctions" style="float:left;margin:0 5px 10px 0">
...
$(".smpushInsertPayload").click(function(){
   if($("#smpushPayload").val() == "" || $("#smpushPayloadTitle").val() == ""){
     return;
   }
   var title = $("#smpushPayloadTitle").val();
   var insert = "{$"+$("#smpushPayload").val();
   if($("#smpushPayloadFormat").val() != ""){
     insert += "|"+$("#smpushPayloadFormat").val();
   }
   if($("#smpushPayloadDefault").val() != ""){
     var defValue = $("#smpushPayloadDefault").val();
   ...
   if($("#smpushPayloadFunction").val() != ""){
     insert += "|"+$("#smpushPayloadFunction").val();
   }
   insert += "}";
   ...
   html += '<input type="button" class="button button-primary" onclick="$(this).closest(\'p\').remove();" style="float:left;margin:0 5px" value="<?php echo __('Remove', 'smpush-plugin-lang')?>">';
   html += '</p>';
   $("#smpushPayloadFields").append(html);
 });
 ...
 $(".smpushPostType").change(function(){
   ...
   $.get("<?php echo $pageurl?>&loadAttri=1", {"noheader": 1, "smpush_post_type" : $(this).val()}, function(data){
     ...
     $(".smpushPostFunctions").html(data["postFuncs"]);
     $(".smpushPostAttriSelector").html(data["postAttrs"]);
   });
 });
