...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        $this->services['template.twig.environment'] = $instance = new \phpbb\template\twig\environment($this->get('config'), $this->get('filesystem'), $this->get('path_helper'), '../cache/installer/twig/', NULL, $this->get('template.twig.loader'), array());
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005220aba800007faa73659a27(
...
class phpbbtemplatetwiglexer_000000005220aba800007faa73659a27 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder590b1cdaa0b0d617535269 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer590b1cdaa0b1c218538363 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties590b1cdaa0aea065149959 = array(
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, 'set_environment', array('env' => $env), $this->initializer590b1cdaa0b1c218538363);

        return $this->valueHolder590b1cdaa0b0d617535269->set_environment($env);
    }
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer590b1cdaa0b1c218538363);

        return $this->valueHolder590b1cdaa0b0d617535269->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer590b1cdaa0b1c218538363);

        return $this->valueHolder590b1cdaa0b0d617535269->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 = $initializer;
    }
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, '__get', array('name' => $name), $this->initializer590b1cdaa0b1c218538363);

        if (isset(self::$publicProperties590b1cdaa0aea065149959[$name])) {
            return $this->valueHolder590b1cdaa0b0d617535269->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder590b1cdaa0b0d617535269;
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer590b1cdaa0b1c218538363);
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, '__isset', array('name' => $name), $this->initializer590b1cdaa0b1c218538363);
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, '__unset', array('name' => $name), $this->initializer590b1cdaa0b1c218538363);
    ...
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, '__clone', array(), $this->initializer590b1cdaa0b1c218538363);

        $this->valueHolder590b1cdaa0b0d617535269 = clone $this->valueHolder590b1cdaa0b0d617535269;
    }

    public function __sleep()
    {
        $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, '__sleep', array(), $this->initializer590b1cdaa0b1c218538363);

        return array('valueHolder590b1cdaa0b0d617535269');
    }
    ...
    {
        return $this->initializer590b1cdaa0b1c218538363;
    }
    ...
    {
        return $this->initializer590b1cdaa0b1c218538363 && $this->initializer590b1cdaa0b1c218538363->__invoke($this->valueHolder590b1cdaa0b0d617535269, $this, 'initializeProxy', array(), $this->initializer590b1cdaa0b1c218538363);
    }
    ...
    {
        return null !== $this->valueHolder590b1cdaa0b0d617535269;
    }
    ...
    {
        return $this->valueHolder590b1cdaa0b0d617535269;
    }
