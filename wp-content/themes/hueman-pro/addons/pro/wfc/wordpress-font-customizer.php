                ...
                if ( ! ( defined( 'TC_BASE_URL' ) || defined( 'HU_BASE_URL' ) ) ) {
                  ...
                  //addon context
                        ...
                        if ( defined( 'TC_BASE_URL' ) ) {
                              ...
                              define( 'TC_WFC_BASE_URL' , sprintf('%s/%s' , TC_BASE_URL . 'addons' , basename( dirname( __FILE__ ) ) ) );

                        }
                        //b) in Hueman-PRO
                        else {

                              define( 'TC_WFC_BASE_URL' , sprintf('%s/%s' , HU_BASE_URL . 'addons/pro/' , basename( dirname( __FILE__ ) ) ) );
