...
class TC_admin_font_customizer {
	...
	*/
	...
	function tc_get_zone_map() {
		if ( ! isset( $this -> tc_zone_map ) )
				$this -> tc_zone_map = 	array(
		...
		return apply_filters( 'tc_font_customizer_zone_map', $this -> tc_zone_map );//end of filters
	}
	...
	************************************************/
	...
	function tc_get_control_tree() {
		$this -> tc_control_tree = isset( $this -> tc_control_tree ) ? $this -> tc_control_tree :
			array(
		...
		return apply_filters('tc_font_customizer_control_tree', $this -> tc_control_tree );//end of filter
	}
      ...
      wp_localize_script(
          ...
          'TCFontAdmin', apply_filters('tc_font_customizer_control_params',
            array(
                ...
                'Zones' 						=> $this -> tc_get_control_zones(),//all zones including those with no settings
