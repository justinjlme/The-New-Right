    ...
    ob_start();
      ?>
        <div class="update-nag">
          ...
          $theme_name,
          __( 'You might need to check for updates on <a href="http://presscustomizr.com/hueman-pro" title="Press Customizr" target="_blank">presscustomizr.com</a> and ', 'hueman' ),
  ...
  */
  function tc_set_correct_changelog_url( $prepared_themes ) {
    ...
    $prepared_themes[$this->theme_slug]['update'] = str_replace(
      'http://presscustomizr.com/extension/hueman-pro/?changelog=1&#038;TB_iframe=true&#038;width=1024&#038;height=800',
