...
class TC_utils_wfc {
    ...
    */
    function tc_get_default_options() {
        ...
        if ( ! $this -> is_customizing && isset( $this -> default_options ) )
          return apply_filters( "{$prefix}_default", $this -> default_options );
        ...
        $this -> defaults_options = apply_filters( "{$prefix}_default", $def_options );
  ...
  function wfc_get_option( $option_name , $option_group = null ) {
    ...
    */
    function tc_customizer_map( $get_default_option = false ) {
        ...
        $tc_font_customizer_settings 	= array();
        $selector_title_map 			= $this -> tc_get_selector_title_map();
		$priority 						= 10;
