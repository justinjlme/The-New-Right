...
return array(
    ...
    'version'       => 'v'.TwitterFeed\PLUGIN_VERSION.' (Commercial)',
    ...
    'subfooter_text'=> 'If you like Twitter Feed, please give it <a target="_blank" href="http://codecanyon.net/item/twitter-feed-social-plugin-for-wordpress/6665168">★★★★★</a> rating on on CodeCanyon.com. Thanks!',
    ...
    'sections'      => array(
        ...
        new Options\Section(array(
            'title'         => 'AJAX',
            'icon'          => 'fa-refresh',
            'description'   => 'Setup how to handle AJAX requests',
            'fields' => array(
                new Components\Spinner(array(
                    'name'          => 'tweet_count',
                    'title'         => 'Tweet Count',
