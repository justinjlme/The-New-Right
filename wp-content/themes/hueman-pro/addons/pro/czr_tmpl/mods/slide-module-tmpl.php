      ...
      <div class="content-wrap">
        <section id="section-topline-1">
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="range_slider" data-transport="postMessage">
              ...
              <div class="czr-input">
                  <input data-type="slider-height" type="range" min="20" max="100" value="{{ data['slider-height'] }}" data-orientation="vertical" />
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="select" data-transport="postMessage">
              ...
              <div class="czr-input">
                <select data-type="skin"></select>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="range_slider" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Skin opacity', 'hueman'); ?></div>
              <div class="czr-input">
                  <input data-type="skin-opacity" type="range" min="0" max="100" value="{{ data['skin-opacity'] }}" data-orientation="horizontal" />
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?> width-100" data-input-type="color" data-transport="postMessage">
              ...
              <div class="czr-input">
                <input data-type="default-bg-color" type="text" value="{{ data['default-bg-color'] }}"></input>
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="upload">
              <div class="customize-control-title"><?php _e('Default background image', 'hueman'); ?></div>
                <div class="<?php echo $css_attr['sub_set_input']; ?>">
                  <input data-type="default-bg-img" type="hidden" value="{{ data['default-bg-img'] }}"/>
        ...
        <section id="section-topline-2">
             <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="range_slider" data-transport="postMessage">
              ...
              <div class="czr-input">
                  <input data-type="caption-vertical-pos" type="range" min="-50" max="50" value="{{ data['caption-vertical-pos'] }}" data-orientation="vertical" />
              </div>
             ...
             <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="fixed-content" type="checkbox" {{ _checked }}></input>
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text" data-transport="postMessage">
              ...
              <div class="czr-input">
                <input data-type="fixed-title" type="text" value="{{ data['fixed-title'] }}" placeholder="<?php _e('Enter a title', 'hueman'); ?>"/>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Subtitle', 'hueman'); ?></div>
              <div class="czr-input">
                <input data-type="fixed-subtitle" type="textarea" value="{{ data['fixed-subtitle'] }}" placeholder="<?php _e('Enter a subtitle', 'hueman'); ?>"/>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Call to action', 'hueman'); ?></div>
              <div class="czr-input">
                <input data-type="fixed-cta" type="textarea" value="{{ data['fixed-cta'] }}" placeholder="<?php _e('Enter a call to action', 'hueman'); ?>"/>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="content_picker">
              ...
              <div class="czr-input">
                <span data-type="fixed-link"></span>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Custom link url', 'hueman'); ?></div>
              <div class="czr-input">
                <input data-type="fixed-custom-link" type="textarea" value="{{ data['fixed-custom-link'] }}" placeholder="<?php _e('http//...', 'hueman'); ?>"/>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check" data-transport="postMessage">
              ...
              <div class="czr-input">
                <input data-type="fixed-link-target" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="number">
              ...
              <div class="czr-input">
                <input data-type="title-max-length" type="number" step="1" min="0" value="{{ data['title-max-length'] }}" />
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="number">
              ...
              <div class="czr-input">
                <input data-type="subtitle-max-length" type="number" step="1" min="0" value="{{ data['subtitle-max-length'] }}" />
              </div>
              <span class="czr-notice"><?php _e('In number of characters.', 'hueman'); ?></span>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="range_slider">
              ...
              <div class="czr-input">
                  <input data-type="font-ratio" type="range" min="-50" max="50" value="{{ data['font-ratio'] }}" data-orientation="horizontal" />
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="use-contextual-data" type="checkbox" {{ _checked }}></input>
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="post-metas" type="checkbox" {{ _checked }}></input>
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="display-cats" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              <#
              ...
              <div class="czr-input">
                <input data-type="display-comments" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              <#
              ...
              <div class="czr-input">
                <input data-type="display-auth-date" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
        </section>
        ...
        <section id="section-topline-3">
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="autoplay" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="number">
              ...
              <div class="czr-input">
                <input data-type="slider-speed" type="number" step="0.5" min="0.5" value="{{ data['slider-speed'] }}" />
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="pause-on-hover" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="parallax" type="checkbox" {{ _checked }}></input>
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="range_slider">
              ...
              <div class="czr-input">
                  <input data-type="parallax-speed" type="range" min="0" max="100" value="{{ data['parallax-speed'] }}" data-orientation="horizontal" />
              </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
                ...
                <div class="czr-input">
                  <input data-type="freescroll" type="checkbox" {{ _checked }}></input>
                </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
                ...
                <div class="czr-input">
                  <input data-type="lazyload" type="checkbox" {{ _checked }}></input>
                </div>
      ...
      <div class="content-wrap">
        ...
        <section id="section-topline-2">
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              <div class="czr-input">
                <input data-type="slide-link-title" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Slide subtitle', 'hueman'); ?></div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Call to action', 'hueman'); ?></div>
              <div class="czr-input">
                <input data-type="slide-cta" type="textarea" value="{{ data['slide-cta'] }}" placeholder="<?php _e('Enter a call to action', 'hueman'); ?>"/>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="content_picker" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Select a content to link', 'hueman'); ?></div>
              <div class="czr-input">
                <span data-type="slide-link"></span>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text" data-transport="postMessage">
              <div class="customize-control-title"><?php _e('Custom link url', 'hueman'); ?></div>
              <div class="czr-input">
                <input data-type="slide-custom-link" type="textarea" value="{{ data['slide-custom-link'] }}" placeholder="<?php _e('http//...', 'hueman'); ?>"/>
              </div>
            </div>
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check" data-transport="postMessage">
              <#
              ...
              <div class="customize-control-title"><?php _e('Open the link in a new browser tab', 'hueman'); ?></div>
              <div class="czr-input">
                <input data-type="slide-link-target" type="checkbox" {{ _checked }}></input>
              </div>
            </div>
        </section>
