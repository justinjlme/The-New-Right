<?php
//require_once( HA_BASE_PATH . 'addons/pro/skop/skop-options.php' );
if ( hu_is_customizing() ) {
  require_once( HA_BASE_PATH . 'addons/pro/sek/sektions-customizer.php' );
  require_once( HA_BASE_PATH . 'addons/pro/sek/tmpl/multi-module-tmpl.php');
  require_once( HA_BASE_PATH . 'addons/pro/sek/tmpl/sektion-module-tmpl.php' );
  require_once( HA_BASE_PATH . 'addons/pro/sek/tmpl/text-module-tmpl.php' );

  //module list
  require_once( HA_BASE_PATH . 'addons/pro/sek/tmpl/available-modules-list-tmpl.php' );

  //sektion settings
  require_once( HA_BASE_PATH . 'addons/pro/sek/tmpl/sektion-settings-tmpl.php' );
}
