...
class PNFW_Notifications {
 ...
 private function is_user_anonymous($user_id) {
  ...
  return in_array(PNFW_Push_Notifications_for_Posts::USER_ROLE, $user->roles) && empty($user->user_email);
 }
 ...
 protected function delete_token($token) {
  ...
  if (in_array(PNFW_Push_Notifications_for_Posts::USER_ROLE, $user->roles) && empty($user->user_email)) {
