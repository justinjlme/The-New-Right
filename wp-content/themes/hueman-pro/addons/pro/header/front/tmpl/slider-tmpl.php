    ...
    ?>
      <div class="carousel-caption-wrapper">
          <div class="carousel-caption">
              ...
              <?php endif; ?>
              <?php
                  printf( '<h1 class="hph-title display-1 thick very-big" style="display:%1$s">%2$s</h1>',
...
function _print_script( $args ) {
    ...
    ?>
      <script type="text/javascript" id="<?php echo $args['module_id']; ?>">
          jQuery( function($) {
                var args = {};
    ...
    <div id="<?php echo $module_id; ?>" class="<?php echo $slider_wrapper_classes; ?>">
        ...
        <?php if ( ! $is_single_slide ) : ?>
          <div class="slider-nav">
              <span class="slider-control slider-prev control-left icn-left-open-big" title="<?php _e( 'previous', 'hueman' ); ?>"><i class="fa fa-chevron-left"></i></span>
              <span class="slider-control slider-next control-right icn-right-open-big" title="<?php _e( 'next', 'hueman' ); ?>"><i class="fa fa-chevron-right"></i></span>
          </div>
        <?php endif; ?>
