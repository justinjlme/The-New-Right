...
class Resource_retweets extends TwitterResource 
{
    const URL_SCRIPT = 'statuses/retweets_of_me.json';
    const CACHE_SLUG = 'retweetsofme';
    ...
    public function build_argument_list( array $args = array() ) 
    {
        ...
        $args['include_rts'] = 'true'; // Must include retweets
