...
<table>
  <tbody>
    <tr valign="middle">
      <td>
        <label class="selectit"><input type="checkbox" name="smpush_mute" <?php if (self::$apisetting['metabox_check_status'] == 1 || $smpush_mute_activated == 'yes') { ?>checked="checked"<?php } ?>> <?php echo __('Mute notification for this post', 'smpush-plugin-lang')?></label>
      </td>
    </tr>
    <tr valign="middle">
      <td>
