...
class Readability
{
	...
	*/	
	function __construct($html, $url=null, $parser='libxml') {
		$this->regexps['unlikelyCandidates'] = apply_filters('wpem_unlikelyCandidates_regexp',$this->regexps['unlikelyCandidates']); // Added by E.T.
		$this->regexps['okMaybeItsACandidate'] = apply_filters('wpem_okMaybeItsACandidate_regexp',$this->regexps['okMaybeItsACandidate']); // Added by E.T.
		$this->regexps['positive'] = apply_filters('wpem_positive_regexp',$this->regexps['positive']); // Added by E.T.
		$this->regexps['negative'] = apply_filters('wpem_negative_regexp',$this->regexps['negative']); // Added by E.T.
		$this->regexps['video'] = apply_filters('wpem_video_regexp',$this->regexps['video']); // Added by E.T. to allow more sites
