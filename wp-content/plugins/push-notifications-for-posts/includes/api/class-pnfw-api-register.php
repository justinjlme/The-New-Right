...
class PNFW_API_Register extends PNFW_API {
 ...
 public function __construct() {
  ...
  if (isset($prevToken)) {
   ...
   if (empty($user_id) || is_null($user_id)) {
    ...
    $user->add_role(PNFW_Push_Notifications_for_Posts::USER_ROLE);
   }
 ...
 private function reassign_token_to($user_id) {
  ...
  if ($this->user_without_tokens($old_user_id)) {
   ...
   if (in_array(PNFW_Push_Notifications_for_Posts::USER_ROLE, $old_user->roles) && empty($old_user->user_email)) {
  ...
  if (!isset($email)) {
   ...
   $user_id = wp_insert_user(array(
    'user_login' => $user_login,
       'user_email' => NULL,
       'user_pass' => NULL,
       'role' => PNFW_Push_Notifications_for_Posts::USER_ROLE
   ));
