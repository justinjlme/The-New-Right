...
},{"modules/countdown/assets/js/frontend/frontend":2,"modules/forms/assets/js/frontend/frontend":7,"modules/posts/assets/js/frontend/frontend":12,"modules/share-buttons/assets/js/frontend/frontend":15,"modules/slides/assets/js/frontend/frontend":17}],2:[function(require,module,exports){
...
module.exports = elementorFrontend.Module.extend( {
	...
	addSectionListener: function( section, callback ) {
		this.setSettings( 'section', section );
		this.setSettings( 'sectionCallback', callback );

		elementorFrontend.addListenerOnce( section + this.getModelCID(), 'section:activated', this.onSectionShow, elementor.channels.editor );
	},

	onSectionShow: function( sectionName, editor ) {
		var self = this,
			_arguments = arguments;

		if ( editor.getOption( 'model' ).cid !== self.getModelCID() ) {
			return;
		}

		if ( sectionName !==  self.getSettings( 'section' ) ) {
			return;
		}

		setTimeout( function() {
			self.getSettings( 'sectionCallback' ).apply( self, _arguments );
		}, 10 );
	}
} );

},{}],5:[function(require,module,exports){
editorModule = require( './editor-module' );

var HandlerModule = editorModule.extend( {
	cache: {},
	...
	onSectionActive: function() {
		this.onElementChange( 'mailchimp_api_key' );
		this.onElementChange( 'mailchimp_list' );
	},
...
module.exports = function( $scope ) {
	new HandlerModule( { $element: $scope } );
};

},{"./editor-module":4}],6:[function(require,module,exports){
editorModule = require( './editor-module' );
...
var HandlerModule = editorModule.extend( {
	...
	onSectionActive: function() {
		var controlView = this.getView( 'form_fields' );
		 ...
		 if ( controlView  ) {
			 ...
			 elementorFrontend.addListenerOnce( this.getModelCID(), 'add change', this.onFieldChanged, controlView.collection );
		 }
	},
	...
	onInit: function() {
		...
		// Panel is ready
		if ( 'editor' ===  elementor.getPanelView().getCurrentPageName() ) {
...
},{"./editor-module":4}],7:[function(require,module,exports){
module.exports = function() {
	...
	if ( 'undefined' !== typeof elementor ) {
		var MailchimpHandler = require( '../editor/mailchimp' );
		elementorFrontend.hooks.addAction( 'frontend/element_ready/subscribe.default', MailchimpHandler );
		elementorFrontend.hooks.addAction( 'frontend/element_ready/form.default', MailchimpHandler );

		// FIXME: Temporary patch for form field shortcode in some servers
		setTimeout( function() {
			var ShortcodeHandler = require( '../editor/shortcode' );
			elementorFrontend.hooks.addAction( 'frontend/element_ready/subscribe.default', ShortcodeHandler );
			elementorFrontend.hooks.addAction( 'frontend/element_ready/form.default', ShortcodeHandler );
		}, 200 );
	}
};

},{"../editor/mailchimp":5,"../editor/shortcode":6,"./handlers/form":10,"./handlers/recaptcha":11}],8:[function(require,module,exports){
module.exports = elementorFrontend.Module.extend( {
...
},{"./form-redirect":8,"./form-sender":9}],11:[function(require,module,exports){
module.exports = function( $scope, $ ) {
...
},{"./handlers/portfolio":13,"./handlers/posts":14}],13:[function(require,module,exports){
...
module.exports = PostsHandler.extend( {
	...
	getDefaultElements: function() {
		...
		elements.$scopeWindow = jQuery( elementorFrontend.getScopeWindow() );
...
},{"./posts":14}],14:[function(require,module,exports){
module.exports = elementorFrontend.Module.extend( {
	getElementName: function() {
		return 'posts';
	},
	...
	isMasonryEnabled: function() {
		return !! this.getElementSettings( 'classic_masonry' );
	},
	...
	runMasonry: function() {
		...
		if ( ! this.isMasonryEnabled() || colsCount < 2 ) {
		...
		$shownPosts.each( function( index ) {
			...
			if ( row ) {
				$post.css( 'transform', 'translateY(-' + ( itemPosition.top - distanceFromTop - heights[ indexAtRow ] ) + 'px)' );
...
},{"./handlers/share-buttons":16}],16:[function(require,module,exports){
...
},{"./handlers/slides":18}],18:[function(require,module,exports){
module.exports = function( $scope, $ ) {
